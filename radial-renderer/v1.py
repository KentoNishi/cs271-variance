...
def plot_whisker(point_x, point_y, perp_angle):
    ...
    x_start = point_x - 0.5 * math.cos(perp_angle)
    y_start = point_y - 0.5 * math.sin(perp_angle)
    x_end = point_x + 0.5 * math.cos(perp_angle)
    y_end = point_y + 0.5 * math.sin(perp_angle)
